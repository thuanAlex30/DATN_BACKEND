...
// ========== Course Routes ==========
// Admin and Manager can view courses
router.get('/courses', 
...
// Admin and Manager can view sessions
router.get('/sessions', 
    RoleMiddleware.requireAnyRole(['admin', 'manager']),
...
// Admin and Manager can view all enrollments, Employee can view their own
...
// Admin and Manager can view assignments
