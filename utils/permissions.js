...
const PERMISSION_MATRIX = {
  ...
  project: {
    ...
    read: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.MAINTENANCE_STAFF, 10, 100],
    update: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.MAINTENANCE_STAFF, 50, 100],
  ...
  training: {
    ...
    read: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.TRAINER, 10, 100],
    ...
    delete: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, 80, 100],
    list: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.TRAINER, 10, 100],
    enroll: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.TRAINER, 10, 100]
  },
  safety: {
    create: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.SAFETY_OFFICER, 10, 100],
    read: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.SAFETY_OFFICER, ROLE_CODES.WAREHOUSE_STAFF, 10, 100],
  ...
  task_workflow: {
    ...
    assign: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, 70, 100],
    update_progress: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, 10, 100],
    comment: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, 10, 100],
    view: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, 10, 100],
    view_logs: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, 10, 100]
  },
  trainer_module: {
    ...
    assessments: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.TRAINER]
  },
  safety_module: {
    reports: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.SAFETY_OFFICER, ROLE_CODES.EMPLOYEE],
  ...
  warehouse_module: {
    ...
    requests: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.WAREHOUSE_STAFF, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE],
  ...
  ppe: {
    ...
    read: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.WAREHOUSE_STAFF, ROLE_CODES.SAFETY_OFFICER, 10, 100],
    ...
    delete: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, 80, 100],
    issue: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.WAREHOUSE_STAFF, 50, 100],
    list: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.WAREHOUSE_STAFF, 10, 100]
  },
  incident: {
    create: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.SAFETY_OFFICER, 10, 100],
    read: [ROLE_CODES.SYSTEM_ADMIN, ROLE_CODES.COMPANY_ADMIN, ROLE_CODES.DEPARTMENT_HEADER, ROLE_CODES.MANAGER, ROLE_CODES.EMPLOYEE, ROLE_CODES.SAFETY_OFFICER, ROLE_CODES.WAREHOUSE_STAFF, ROLE_CODES.MAINTENANCE_STAFF, 10, 100],
...
const ROLE_PERMISSIONS = {
  ...
  // System Admin - full quyền admin toàn hệ thống (global)
  [ROLES.SYSTEM_ADMIN]: [
    // Core administration
    PERMISSIONS.USER_CREATE,
    PERMISSIONS.USER_READ,
  ...
  // Company Admin - chỉ quản trị trong phạm vi tenant, KHÔNG xem analytics global
  [ROLES.COMPANY_ADMIN]: [
    // User management trong tenant
    PERMISSIONS.USER_CREATE,
    PERMISSIONS.USER_READ,
    PERMISSIONS.USER_UPDATE,
    PERMISSIONS.USER_DELETE,
    ...
    // Role management: được xem và cập nhật cấu hình role trong phạm vi tenant
    PERMISSIONS.ROLE_READ,
    PERMISSIONS.ROLE_UPDATE,
    PERMISSIONS.ROLE_LIST,

    // Department management trong tenant
    PERMISSIONS.DEPARTMENT_CREATE,
    PERMISSIONS.DEPARTMENT_READ,
    PERMISSIONS.DEPARTMENT_UPDATE,
    PERMISSIONS.DEPARTMENT_DELETE,
    ...
    // Analytics: chỉ trong tenant / department, không có quyền xem global
    PERMISSIONS.ANALYTICS_VIEW_TENANT,
    PERMISSIONS.ANALYTICS_VIEW_DEPARTMENT
  ],
  ...
  static hasPermission(userRole, permission, options = {}) {
    ...
    if (userRole && typeof userRole === 'object' && userRole.permissions) {
      ...
      const permissionMapping = {
        ...
        'role:read': 'read_role',
        'role:update': ['update_role', 'assign_role'], 
      ...
      if (mappedPermission) {
        const permissionAliases = Array.isArray(mappedPermission) ? mappedPermission : [mappedPermission];
        ...
        for (const key of managementKeys) {
          if (!permissions[key] || !Array.isArray(permissions[key])) {
            continue;
          }
          
          const hasAlias = permissionAliases.some(alias => alias && permissions[key].includes(alias));
          if (hasAlias) {
            return true;
          }
        }
  ...
  static hasMatrixPermission(userRole, module, action) {
    ...
    const hasPermission = allowedRoles.some(allowed => {
      ...
      if (typeof allowed === 'string') {
        ...
        // Direct match
        if (userRoleCodeLower === allowedLower) {
        ...
        const userRoleName = userRole.role_name?.toLowerCase().trim();
        if (userRoleName === allowedLower) {
    ...
    console.log(`🔍 hasMatrixPermission result: ${hasPermission}`);
