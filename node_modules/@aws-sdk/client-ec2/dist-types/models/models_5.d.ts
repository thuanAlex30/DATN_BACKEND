import { AllowedImagesSettingsDisabledState, AllowedImagesSettingsEnabledState, ArchitectureType, CapacityManagerStatus, CapacityReservationState, CapacityTenancy, ClientCertificateRevocationListStatusCode, Comparison, CurrencyCodeValues, DeviceTrustProviderType, DiskImageFormat, DnsNameState, EkPubKeyFormat, EkPubKeyType, FastLaunchResourceType, FastLaunchStateCode, FastSnapshotRestoreStateCode, FilterByDimension, GroupBy, HttpTokensState, ImageBlockPublicAccessDisabledState, ImageBlockPublicAccessEnabledState, IngestionStatus, InstanceMetadataEndpointState, InstanceMetadataTagsState, InternetGatewayBlockMode, IpAddressType, IpamAddressHistoryResourceType, IpamComplianceStatus, IpamDiscoveryFailureCode, IpamNetworkInterfaceAttachmentStatus, IpamOverlapStatus, IpamPolicyManagedBy, IpamPolicyResourceType, IpamPublicAddressAssociationStatus, IpamPublicAddressAwsService, IpamPublicAddressType, IpamResourceCidrIpSource, IpamResourceType, ManagedBy, Metric, MetricType, PartitionLoadFrequency, PayerResponsibility, PaymentOption, PeriodType, ReservationEndDateType, ReservationState, ReservationType, RouteServerPropagationState, SecurityGroupVpcAssociationState, ServiceConnectivityType, SnapshotBlockPublicAccessState, SSEType, State, StatisticType, TransitGatewayAttachmentResourceType, TransitGatewayPropagationState, UnlimitedSupportedInstanceFamily, UserTrustProviderType, VirtualizationType, VpcAttributeName, VpcBlockPublicAccessExclusionsAllowed, VpcBlockPublicAccessState } from "./enums";
import { ActiveVpnTunnelStatus, AddressTransfer, AllowedPrincipal, AsnAssociation, AssociationStatus, IamInstanceProfileAssociation, InstanceEventWindow, IpamPoolAllocation, IpamResourceDiscoveryAssociation, NatGatewayAddress, RouteServerAssociation, SubnetIpv6CidrBlockAssociation, Tag, TagSpecification, TransitGatewayAssociation, TransitGatewayMulticastDomainAssociations, TransitGatewayPolicyTableAssociation, VerifiedAccessInstance, VerifiedAccessTrustProvider, Vpc, VpcCidrBlockAssociation, VpcIpv6CidrBlockAssociation, VpcPeeringConnection } from "./models_0";
...
import { AttributeBooleanValue, ExportTaskS3Location, FastLaunchLaunchTemplateSpecificationResponse, FastLaunchSnapshotConfigurationResponse, Filter, RegisteredInstance } from "./models_3";
