...
import { DnsOptionsSpecification, IKEVersionsRequestListValue, Phase1DHGroupNumbersRequestListValue, Phase1EncryptionAlgorithmsRequestListValue, Phase1IntegrityAlgorithmsRequestListValue, Phase2DHGroupNumbersRequestListValue, Phase2EncryptionAlgorithmsRequestListValue, Phase2IntegrityAlgorithmsRequestListValue, SubnetCidrReservation, SubnetConfiguration, TrafficMirrorFilter, TrafficMirrorFilterRule, TrafficMirrorPortRangeRequest, TrafficMirrorSession, TransitGateway, TransitGatewayPrefixListReference, VerifiedAccessEndpoint, VerifiedAccessGroup, VerifiedAccessSseSpecificationRequest, VpcBlockPublicAccessExclusion, VpnConnection, VpnTunnelLogOptionsSpecification } from "./models_2";
import { AttributeBooleanValue, ConversionTask, Filter, FpgaImageAttribute, ImportImageLicenseConfigurationResponse, InstanceMetadataOptionsResponse, InstanceStatusEvent, IpamPoolCidr, LaunchPermission, SnapshotDetail, SnapshotTaskDetail } from "./models_3";
import { CreateVolumePermission, LaunchTemplateConfig, ReservedInstancesConfiguration, VerifiedAccessInstanceLoggingConfiguration, VolumeModification } from "./models_4";
import { InstanceFamilyCreditSpecification, IpamPolicyDocument, RouteServerPropagation, VpcBlockPublicAccessOptions } from "./models_5";
/**
 * @public
 */
